...
function Home(){
    ...
    <div className='navigate anta-regular'>
        ...
        <a href='https://drive.google.com/file/d/1939ZgLA777BE7ofH_VT-9vC_mUsbjBFw/view?usp=sharing' className='resume'><p>Resume</p></a>
        ...
        <div id='ski'>
            <p className='a1'>About</p>
            <p className='a2'>My Skills</p>
        </div>
        <div className='social'>
        <a href='https://www.linkedin.com/in/rakeshrajendiran'>
        ...
        <a href='https://github.com/Its-Rakesh-R'>
            <svg xmlns="http://www.w3.org/2000/svg" className='' width="16" height="16" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
            <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27s1.36.09 2 .27c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0 0 16 8c0-4.42-3.58-8-8-8"/>
            </svg>
        </a>
        <a href="https://www.instagram.com/rakeshr__r/?next=%2F">
            <svg xmlns="http://www.w3.org/2000/svg" className='' width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
        ...
        <a href='https://www.facebook.com/rakesh.rak.5855594?mibextid=ZbWKwL'>
            <svg xmlns="http://www.w3.org/2000/svg" className='' width="25" height="25" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
            </svg>
        </a>
        <a href=' https://x.com/rakesh_r12?t=zz-a4i3tslM-ikjnhQiXOw&s=08 '>
            <svg xmlns="http://www.w3.org/2000/svg" className='' width="16" height="16" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
