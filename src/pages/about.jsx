...
function About(){
    ...
    transition={{ duration: 0.75, ease: "easeInOut", delay:0.01 }}
     className='abouth animat-abote'>
        ...
        className='about-sec'>
            I'm Rakesh R, a software developer with expertise in web development and full-stack engineering, driven by a passion for building efficient and scalable applications.
            <br/>
            <br/>
            During my internship at Brainvalley, I gained hands-on experience working with technologies like JavaScript, React, Redux, Python, Node.js, Express.js, MongoDB, and AWS. This allowed me to sharpen my skills in both front-end and back-end development.
            <br/>
            <br/>
            I've completed projects such as developing a website for a children's charity and building a system for aluminum extraction and scrap management, showcasing my technical abilities and problem-solving mindset. Let’s create something amazing together!
            
        </motion.div>
        <div className='bdesign'>
        {/* <ParticlesComponent id='bg'/> */}
        {/* <canvas className='canva' width="872" height="616"></canvas> */}
        <div
         className='flot1'>
            <motion.img
            initial={{y:'200%',x:'200%'}}
        ...
        <h1 className='bapg roboto-black'>ABOUT</h1>
        </div>
